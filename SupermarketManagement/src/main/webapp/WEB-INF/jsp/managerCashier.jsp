...
<title>Manager/Cashier Login Page</title>
...
<div class="login-form">
    <form action="/managerCashier" method="post" onsubmit="return validateForm()">
        <h2 class="text-center">Login for Manager/Cashier</h2>       
