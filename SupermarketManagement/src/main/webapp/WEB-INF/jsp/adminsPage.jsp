...
<div class="wrapper">
        <div class="container">
	<h1>
		<center>Welcome To The Admin's Page</center>
	</h1>
	...
	<center>
			...
			<form action="/viewRDetails" method="get"><input type="submit" class="btnSubmit" name="submit" value="Registration Requests"></form>
